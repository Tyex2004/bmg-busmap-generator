...
from src.generator import (generate_road_previewer, get_papersize,
                           draw_preview_roads, draw_preview_nodes, draw_preview_stations)
...
# 绘制道路预览
draw_preview_roads(road_previewer, nodes, roads, paper_size, prior_center)                  # 绘制道路
draw_preview_nodes(road_previewer, nodes, paper_size, prior_center)                         # 绘制节点
draw_preview_stations(road_previewer, nodes, roads, stations, paper_size, prior_center)     # 绘制站点
